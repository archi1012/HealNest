<?php $__env->startSection('title', 'Register – HealNest'); ?>
...
<form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
    ...
    <div>
        ...
        <input type="number" name="age" value="<?php echo e(old('age')); ?>" min="15" max="30" required
               class="w-full border border-tan/40 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-midgreen bg-cream">
    </div>
    ...
    <div>
        ...
        <select name="role" class="w-full border border-tan/40 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-midgreen bg-cream">
            <option value="user" <?php echo e(old('role') === 'user' ? 'selected' : ''); ?>>User (Self-tracking)</option>
...
<p class="text-center text-sm text-gray-500 mt-4">
    ...
    <a href="<?php echo e(route('login')); ?>" class="text-midgreen font-semibold hover:underline">Sign in</a>
</p>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Adit/Documents/GitHub/HealNest/HealNest/resources/views/auth/register.blade.php ENDPATH**/ ?>