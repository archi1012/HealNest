<?php $__env->startSection('title', 'Login – HealNest'); ?>
...
<form method="POST" action="/login" class="space-y-4" id="loginForm">
    ...
    <div>
        ...
        <input type="email" name="email" id="emailInput" value="<?php echo e(old('email')); ?>" required autofocus
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Adit/Documents/GitHub/HealNest/HealNest/resources/views/auth/login.blade.php ENDPATH**/ ?>